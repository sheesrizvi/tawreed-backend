...
const { createCategory, getAllCategory, deleteCategory, createBrand, getAllBrands, deleteBrand, createProduct, getAllProduct, deleteProduct, updateProduct } = require("../controller/ecomController");
const { ecomSellers, deleteSeller, allEcomSellers } = require("../controller/adminController");
